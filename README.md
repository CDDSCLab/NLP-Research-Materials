...
- [自然语言处理](./自然语言处理)
	...
	- [论文](./自然语言处理/论文)
		...
		- [C事件检测](./自然语言处理/论文/C事件检测)
			- [A Language-Independent Neural Network for Event Detection.pdf](./自然语言处理/论文/C事件检测/A%20Language-Independent%20Neural%20Network%20for%20Event%20Detection.pdf)
			- [A+Comparison+of+the+Events+and+Relations+Across+ACE,+ERE,+TAC-KBP,【翻译狗www.fanyigou.com】.pdf](./自然语言处理/论文/C事件检测/A+Comparison+of+the+Events+and+Relations+Across+ACE,+ERE,+TAC-KBP,【翻译狗www.fanyigou.com】.pdf)
			...
			- [DMCNN.pdf](./自然语言处理/论文/C事件检测/DMCNN.pdf)
			- [DMCNN笔记.docx](./自然语言处理/论文/C事件检测/DMCNN笔记.docx)
			- [envent detection without tagger.pdf](./自然语言处理/论文/C事件检测/envent%20detection%20without%20tagger.pdf)
			- [Event Detection via Gated Multilingual Attention Mechanism.pdf](./自然语言处理/论文/C事件检测/Event%20Detection%20via%20Gated%20Multilingual%20Attention%20Mechanism.pdf)
			- [gan与事件检测](./自然语言处理/论文/C事件检测/gan与事件检测)
			- [gcn ee](./自然语言处理/论文/C事件检测/gcn%20ee)
			- [HMEAE Hierarchical Modular Event Argument Extraction.pdf](./自然语言处理/论文/C事件检测/HMEAE%20Hierarchical%20Modular%20Event%20Argument%20Extraction.pdf)
			...
			- [untitled.fig](./自然语言处理/论文/C事件检测/untitled.fig)
			- [ZSL](./自然语言处理/论文/C事件检测/ZSL)
			- [~$检测通用笔记.doc](./自然语言处理/论文/C事件检测/~$检测通用笔记.doc)
			- [中文事件检测propose.pdf](./自然语言处理/论文/C事件检测/中文事件检测propose.pdf)
			- [中文粒度混合DMCNN——NPN.pdf](./自然语言处理/论文/C事件检测/中文粒度混合DMCNN——NPN.pdf)
			...
			- [自注意力总结.url](./自然语言处理/论文/C事件检测/自注意力总结.url)
